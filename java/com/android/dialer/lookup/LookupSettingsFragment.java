...
public class LookupSettingsFragment extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mEnableForwardLookup) {
            EVSettings.System.putInt(cr, EVSettings.System.ENABLE_FORWARD_LOOKUP,
                    ((Boolean) newValue) ? 1 : 0);
        } else if (preference == mEnablePeopleLookup) {
            EVSettings.System.putInt(cr, EVSettings.System.ENABLE_PEOPLE_LOOKUP,
                    ((Boolean) newValue) ? 1 : 0);
        } else if (preference == mEnableReverseLookup) {
            EVSettings.System.putInt(cr, EVSettings.System.ENABLE_REVERSE_LOOKUP,
                    ((Boolean) newValue) ? 1 : 0);
        } else if (preference == mForwardLookupProvider) {
            EVSettings.System.putString(cr, EVSettings.System.FORWARD_LOOKUP_PROVIDER,
                    (String) newValue);
        } else if (preference == mPeopleLookupProvider) {
            EVSettings.System.putString(cr, EVSettings.System.PEOPLE_LOOKUP_PROVIDER,
                    (String) newValue);
        } else if (preference == mReverseLookupProvider) {
            EVSettings.System.putString(cr, EVSettings.System.REVERSE_LOOKUP_PROVIDER,
                    (String) newValue);
        }
    ...
    private void restoreLookupProviderSwitches() {
        final ContentResolver cr = getActivity().getContentResolver();
        mEnableForwardLookup.setChecked(EVSettings.System.getInt(cr,
                EVSettings.System.ENABLE_FORWARD_LOOKUP, 0) != 0);
        mEnablePeopleLookup.setChecked(EVSettings.System.getInt(cr,
                EVSettings.System.ENABLE_PEOPLE_LOOKUP, 0) != 0);
        mEnableReverseLookup.setChecked(EVSettings.System.getInt(cr,
                EVSettings.System.ENABLE_REVERSE_LOOKUP, 0) != 0);
    }
    ...
    private void restoreLookupProvider(ListPreference pref, String key) {
        ...
        final ContentResolver cr = getActivity().getContentResolver();
        String provider = EVSettings.System.getString(cr, key);
        if (provider == null) {
            pref.setValueIndex(0);
            EVSettings.System.putString(cr, key, pref.getValue());
        } else {
